...
final class Version20230202162157 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, name VARCHAR(128) NOT NULL, surname VARCHAR(128) NOT NULL, email VARCHAR(256) NOT NULL, phone_number VARCHAR(35) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('INSERT INTO "user" (id, name, surname, email, phone_number) VALUES (1, \'Kamil\', \'Duszyński\', \'kamil.duszynski@softwarelab.pl\', \'+48518260247\')');
    }
